...
#if defined(TARGET_IS_i386pe)     || defined(TARGET_IS_shpe)     || defined(TARGET_IS_armpe)     || defined(TARGET_IS_arm_wince_pe)
#define DLL_SUPPORT
#endif
...
#define DEFAULT_DLL_CHARACTERISTICS	(0 					 ? IMAGE_DLL_CHARACTERISTICS_DYNAMIC_BASE 					   | IMAGE_DLL_CHARACTERISTICS_NX_COMPAT 					 : 0)
...
/* Get symbol name dependent to kind and C visible state of
   underscore.  */
#define GET_INIT_SYMBOL_NAME(IDX)   (init[(IDX)].symbol    + ((!init[(IDX)].is_c_symbol || is_underscoring () != 0) ? 0 : 1))
...
static void
gldi386pe_before_plugin_all_symbols_read (void)
{
#ifdef DLL_SUPPORT
...
gldi386pe_find_alt_start_symbol
...
SEARCH_DIR(\"/usr/local/i686-pc-pe/lib\");\n\
SECTIONS\n\
{\n\
  .text  :\n\
  {\n\
...
struct ld_emulation_xfer_struct ld_i386pe_emulation =
{
  ...
  gldi386pe_before_plugin_all_symbols_read,
