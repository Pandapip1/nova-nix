...
#if !defined (SELECT_VECS) || defined (HAVE_cris_elf32_vec)

{ "cris-*-linux-*", NULL },{ "crisv32-*-linux-*",
&cris_elf32_vec },
#endif
...
#if !defined (SELECT_VECS) || defined (HAVE_cris_elf32_us_vec)
...
#if !defined (SELECT_VECS) || defined (HAVE_x86_64_elf64_sol2_vec)
...
#ifdef BFD64
#if !defined (SELECT_VECS) || defined (HAVE_sparc_elf64_sol2_vec)

{ "sparcv9-*-solaris2*", NULL },{ "sparc64-*-solaris2*",
