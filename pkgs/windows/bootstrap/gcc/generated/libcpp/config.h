...
/* #undef HAVE_ICONV */ /* ntlibc audit: ntlibc has no <iconv.h> */

/* Define to 1 if you have the <inttypes.h> header file. */
#define HAVE_INTTYPES_H 1

/* Define if you have <langinfo.h> and nl_langinfo(CODESET). */
/* #undef HAVE_LANGINFO_CODESET */ /* ntlibc audit: ntlibc has no <langinfo.h> */
...
/* #undef HAVE_OBSTACK */ /* ntlibc audit: ntlibc has no <obstack.h> -- moot either way, libcpp's own files.c/directives.c #include "obstack.h" unconditionally (quoted, gcc's own bundled fallback), never gated on this macro */
...
/* #undef HAVE_SSE4 */ /* ntlibc audit: not a libc question -- gates an inline-asm SSE4 fast path in lex.c behind this chain's own tcc assembler, whose SSE4 support is unconfirmed; left off, falls back to the plain C loop */
...
#define SIZEOF_LONG 4 /* ntlibc audit: ILP32 i686-pc-mingw32 target, not the reference x86_64-linux host's 8 -- same correction as gcc's own auto-host.h (cb7942f) */
