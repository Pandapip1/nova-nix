...
enum opt_code
{
  ...
  OPT_Wpedantic_ms_format = 236,             /* -Wpedantic-ms-format */
  OPT_Wpmf_conversions = 237,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 238,                  /* -Wpointer-arith */
  OPT_Wpointer_sign = 239,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 240,            /* -Wpointer-to-int-cast */
  OPT_Wpragmas = 241,                        /* -Wpragmas */
  OPT_Wproperty_assign_default = 242,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 243,                       /* -Wprotocol */
  OPT_Wpsabi = 244,                          /* -Wpsabi */
  OPT_Wredundant_decls = 245,                /* -Wredundant-decls */
  OPT_Wreorder = 246,                        /* -Wreorder */
  OPT_Wreturn_type = 247,                    /* -Wreturn-type */
  OPT_Wselector = 248,                       /* -Wselector */
  OPT_Wsequence_point = 249,                 /* -Wsequence-point */
  OPT_Wshadow = 250,                         /* -Wshadow */
  OPT_Wsign_compare = 251,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 252,                /* -Wsign-conversion */
  OPT_Wsign_promo = 253,                     /* -Wsign-promo */
  OPT_Wstack_protector = 254,                /* -Wstack-protector */
  OPT_Wstrict_aliasing = 255,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 256,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 257,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 258,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 259,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 260,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 261,          /* -Wstrict-selector-match */
  OPT_Wsuggest_attribute_const = 262,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_noreturn = 263,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 264,         /* -Wsuggest-attribute=pure */
  OPT_Wswitch = 265,                         /* -Wswitch */
  OPT_Wswitch_default = 266,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 267,                    /* -Wswitch-enum */
  OPT_Wsync_nand = 268,                      /* -Wsync-nand */
  OPT_Wsynth = 269,                          /* -Wsynth */
  OPT_Wsystem_headers = 270,                 /* -Wsystem-headers */
  OPT_Wtraditional = 271,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 272,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 273,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 274,                      /* -Wtrigraphs */
  OPT_Wtype_limits = 275,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 276,            /* -Wundeclared-selector */
  OPT_Wundef = 277,                          /* -Wundef */
  OPT_Wuninitialized = 278,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 279,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 280, */         /* -Wunreachable-code */
  OPT_Wunsafe_loop_optimizations = 281,      /* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 282,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 283,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 284,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 285,        /* -Wunused-but-set-variable */
  OPT_Wunused_function = 286,                /* -Wunused-function */
  OPT_Wunused_label = 287,                   /* -Wunused-label */
  OPT_Wunused_macros = 288,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 289,               /* -Wunused-parameter */
  OPT_Wunused_result = 290,                  /* -Wunused-result */
  OPT_Wunused_value = 291,                   /* -Wunused-value */
  OPT_Wunused_variable = 292,                /* -Wunused-variable */
  OPT_Wvariadic_macros = 293,                /* -Wvariadic-macros */
  OPT_Wvla = 294,                            /* -Wvla */
  OPT_Wvolatile_register_var = 295,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 296,                  /* -Wwrite-strings */
  OPT_Xassembler = 297,                      /* -Xassembler */
  OPT_Xlinker = 298,                         /* -Xlinker */
  OPT_Xpreprocessor = 299,                   /* -Xpreprocessor */
  OPT_Z = 300,                               /* -Z */
  OPT_ansi = 301,                            /* -ansi */
  OPT_aux_info = 302,                        /* -aux-info */
  /* OPT_aux_info_ = 303, */                 /* -aux-info= */
  OPT_auxbase = 304,                         /* -auxbase */
  OPT_auxbase_strip = 305,                   /* -auxbase-strip */
  OPT_c = 306,                               /* -c */
  OPT_coverage = 307,                        /* -coverage */
  OPT_d = 308,                               /* -d */
  OPT_dumpbase = 309,                        /* -dumpbase */
  OPT_dumpdir = 310,                         /* -dumpdir */
  OPT_dumpmachine = 311,                     /* -dumpmachine */
  OPT_dumpspecs = 312,                       /* -dumpspecs */
  OPT_dumpversion = 313,                     /* -dumpversion */
  OPT_e = 314,                               /* -e */
  OPT_export_dynamic = 315,                  /* -export-dynamic */
  OPT_fPIC = 316,                            /* -fPIC */
  OPT_fPIE = 317,                            /* -fPIE */
  OPT_fabi_version_ = 318,                   /* -fabi-version= */
  OPT_faccess_control = 319,                 /* -faccess-control */
  OPT_falign_functions = 320,                /* -falign-functions */
  OPT_falign_functions_ = 321,               /* -falign-functions= */
  OPT_falign_jumps = 322,                    /* -falign-jumps */
  OPT_falign_jumps_ = 323,                   /* -falign-jumps= */
  OPT_falign_labels = 324,                   /* -falign-labels */
  OPT_falign_labels_ = 325,                  /* -falign-labels= */
  OPT_falign_loops = 326,                    /* -falign-loops */
  OPT_falign_loops_ = 327,                   /* -falign-loops= */
  /* OPT_fall_virtual = 328, */              /* -fall-virtual */
  /* OPT_falt_external_templates = 329, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 330, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 331, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 332, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 333, */  /* -fargument-noalias-global */
  OPT_fasm = 334,                            /* -fasm */
  OPT_fassociative_math = 335,               /* -fassociative-math */
  OPT_fasynchronous_unwind_tables = 336,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 337,                   /* -fauto-inc-dec */
  OPT_fbounds_check = 338,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 339,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 340,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 341,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 342,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 343,               /* -fbtr-bb-exclusive */
  OPT_fbuiltin = 344,                        /* -fbuiltin */
  OPT_fbuiltin_ = 345,                       /* -fbuiltin- */
  OPT_fcall_saved_ = 346,                    /* -fcall-saved- */
  OPT_fcall_used_ = 347,                     /* -fcall-used- */
  OPT_fcaller_saves = 348,                   /* -fcaller-saves */
  OPT_fcheck_data_deps = 349,                /* -fcheck-data-deps */
  OPT_fcheck_new = 350,                      /* -fcheck-new */
  OPT_fcombine_stack_adjustments = 351,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 352,                         /* -fcommon */
  OPT_fcompare_debug = 353,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 354,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 355,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 356,                   /* -fcompare-elim */
  OPT_fcond_mismatch = 357,                  /* -fcond-mismatch */
  OPT_fconserve_space = 358,                 /* -fconserve-space */
  OPT_fconserve_stack = 359,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 360,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 361,               /* -fconstexpr-depth= */
  OPT_fcprop_registers = 362,                /* -fcprop-registers */
  OPT_fcrossjumping = 363,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 364,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 365, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 366,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 367,               /* -fcx-limited-range */
  OPT_fdata_sections = 368,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 369,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 370,                       /* -fdbg-cnt= */
  OPT_fdce = 371,                            /* -fdce */
  OPT_fdebug_prefix_map_ = 372,              /* -fdebug-prefix-map= */
  OPT_fdeduce_init_list = 373,               /* -fdeduce-init-list */
  /* OPT_fdefault_inline = 374, */           /* -fdefault-inline */
  OPT_fdefer_pop = 375,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 376,                 /* -fdelayed-branch */
  OPT_fdelete_null_pointer_checks = 377,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 378,                   /* -fdevirtualize */
  OPT_fdiagnostics_show_location_ = 379,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 380,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 381,                /* -fdirectives-only */
  OPT_fdollars_in_identifiers = 382,         /* -fdollars-in-identifiers */
  OPT_fdse = 383,                            /* -fdse */
  OPT_fdump_ = 384,                          /* -fdump- */
  OPT_fdump_final_insns = 385,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 386,              /* -fdump-final-insns= */
  OPT_fdump_go_spec_ = 387,                  /* -fdump-go-spec= */
  OPT_fdump_noaddr = 388,                    /* -fdump-noaddr */
  OPT_fdump_unnumbered = 389,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 390,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 391,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 392,                 /* -fearly-inlining */
  OPT_felide_constructors = 393,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 394,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 395, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 396,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 397,        /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 398,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 399,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 400,      /* -femit-struct-debug-reduced */
  OPT_fenable_icf_debug = 401,               /* -fenable-icf-debug */
  OPT_fenforce_eh_specs = 402,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 403, */           /* -fenum-int-equiv */
  OPT_fexceptions = 404,                     /* -fexceptions */
  OPT_fexcess_precision_ = 405,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 406,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 407,        /* -fexpensive-optimizations */
  OPT_fextended_identifiers = 408,           /* -fextended-identifiers */
  /* OPT_fexternal_templates = 409, */       /* -fexternal-templates */
  OPT_ffast_math = 410,                      /* -ffast-math */
  OPT_ffinite_math_only = 411,               /* -ffinite-math-only */
  OPT_ffixed_ = 412,                         /* -ffixed- */
  OPT_ffloat_store = 413,                    /* -ffloat-store */
  OPT_ffor_scope = 414,                      /* -ffor-scope */
  /* OPT_fforce_addr = 415, */               /* -fforce-addr */
  OPT_fforward_propagate = 416,              /* -fforward-propagate */
  OPT_ffp_contract_ = 417,                   /* -ffp-contract= */
  OPT_ffreestanding = 418,                   /* -ffreestanding */
  OPT_ffriend_injection = 419,               /* -ffriend-injection */
  OPT_ffunction_cse = 420,                   /* -ffunction-cse */
  OPT_ffunction_sections = 421,              /* -ffunction-sections */
  OPT_fgcse = 422,                           /* -fgcse */
  OPT_fgcse_after_reload = 423,              /* -fgcse-after-reload */
  OPT_fgcse_las = 424,                       /* -fgcse-las */
  OPT_fgcse_lm = 425,                        /* -fgcse-lm */
  OPT_fgcse_sm = 426,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 427,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 428,                    /* -fgnu-runtime */
  OPT_fgnu89_inline = 429,                   /* -fgnu89-inline */
  OPT_fgraphite = 430,                       /* -fgraphite */
  OPT_fgraphite_identity = 431,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 432,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 433, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 434, */        /* -fhandle-exceptions */
  /* OPT_fhelp = 435, */                     /* -fhelp */
  /* OPT_fhelp_ = 436, */                    /* -fhelp= */
  /* OPT_fhonor_std = 437, */                /* -fhonor-std */
  OPT_fhosted = 438,                         /* -fhosted */
  /* OPT_fhuge_objects = 439, */             /* -fhuge-objects */
  OPT_fident = 440,                          /* -fident */
  OPT_fif_conversion = 441,                  /* -fif-conversion */
  OPT_fif_conversion2 = 442,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 443,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 444,      /* -fimplicit-inline-templates */
  OPT_fimplicit_templates = 445,             /* -fimplicit-templates */
  OPT_findirect_inlining = 446,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 447,         /* -finhibit-size-directive */
  OPT_finline = 448,                         /* -finline */
  OPT_finline_functions = 449,               /* -finline-functions */
  OPT_finline_functions_called_once = 450,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 451, */            /* -finline-limit- */
  OPT_finline_limit_ = 452,                  /* -finline-limit= */
  OPT_finline_small_functions = 453,         /* -finline-small-functions */
  OPT_finput_charset_ = 454,                 /* -finput-charset= */
  OPT_finstrument_functions = 455,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 456,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 457,/* -finstrument-functions-exclude-function-list= */
  OPT_fipa_cp = 458,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 459,                   /* -fipa-cp-clone */
  OPT_fipa_matrix_reorg = 460,               /* -fipa-matrix-reorg */
  OPT_fipa_profile = 461,                    /* -fipa-profile */
  OPT_fipa_pta = 462,                        /* -fipa-pta */
  OPT_fipa_pure_const = 463,                 /* -fipa-pure-const */
  OPT_fipa_reference = 464,                  /* -fipa-reference */
  OPT_fipa_sra = 465,                        /* -fipa-sra */
  OPT_fipa_struct_reorg = 466,               /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 467,                 /* -fira-algorithm= */
  OPT_fira_loop_pressure = 468,              /* -fira-loop-pressure */
  OPT_fira_region_ = 469,                    /* -fira-region= */
  OPT_fira_share_save_slots = 470,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 471,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 472,                   /* -fira-verbose= */
  OPT_fivopts = 473,                         /* -fivopts */
  OPT_fjump_tables = 474,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 475,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 476,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 477,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 478, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 479,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 480,             /* -fleading-underscore */
  OPT_floop_block = 481,                     /* -floop-block */
  OPT_floop_flatten = 482,                   /* -floop-flatten */
  OPT_floop_interchange = 483,               /* -floop-interchange */
  /* OPT_floop_optimize = 484, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 485,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 486,                /* -floop-strip-mine */
  OPT_flto = 487,                            /* -flto */
  OPT_flto_compression_level_ = 488,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 489,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 490,         /* -flto-partition=balanced */
  OPT_flto_partition_none = 491,             /* -flto-partition=none */
  OPT_flto_report = 492,                     /* -flto-report */
  OPT_flto_ = 493,                           /* -flto= */
  OPT_fltrans = 494,                         /* -fltrans */
  OPT_fltrans_output_list_ = 495,            /* -fltrans-output-list= */
  OPT_fmath_errno = 496,                     /* -fmath-errno */
  OPT_fmax_errors_ = 497,                    /* -fmax-errors= */
  OPT_fmem_report = 498,                     /* -fmem-report */
  OPT_fmerge_all_constants = 499,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 500,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 501,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 502,                /* -fmessage-length= */
  OPT_fmodulo_sched = 503,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 504,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 505,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 506,                  /* -fms-extensions */
  OPT_fmudflap = 507,                        /* -fmudflap */
  OPT_fmudflapir = 508,                      /* -fmudflapir */
  OPT_fmudflapth = 509,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 510, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 511, */                  /* -fnew-abi */
  OPT_fnext_runtime = 512,                   /* -fnext-runtime */
  OPT_fnil_receivers = 513,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 514,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 515,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 516, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 517,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 518,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 519,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 520,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 521,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 522,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 523,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 524,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 525,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 526,             /* -fomit-frame-pointer */
  OPT_fopenmp = 527,                         /* -fopenmp */
  OPT_foperator_names = 528,                 /* -foperator-names */
  OPT_foptimize_register_move = 529,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 530,         /* -foptimize-sibling-calls */
  /* OPT_foptional_diags = 531, */           /* -foptional-diags */
  OPT_fpack_struct = 532,                    /* -fpack-struct */
  OPT_fpack_struct_ = 533,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 534,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 535,              /* -fpcc-struct-return */
  OPT_fpch_deps = 536,                       /* -fpch-deps */
  OPT_fpch_preprocess = 537,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 538,                     /* -fpeel-loops */
  OPT_fpeephole = 539,                       /* -fpeephole */
  OPT_fpeephole2 = 540,                      /* -fpeephole2 */
  OPT_fpermissive = 541,                     /* -fpermissive */
  OPT_fpic = 542,                            /* -fpic */
  OPT_fpie = 543,                            /* -fpie */
  OPT_fplan9_extensions = 544,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 545,                    /* -fplugin-arg- */
  OPT_fplugin_ = 546,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 547,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 548,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 549,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 550,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 551,                   /* -fpreprocessed */
  OPT_fpretty_templates = 552,               /* -fpretty-templates */
  OPT_fprofile = 553,                        /* -fprofile */
  OPT_fprofile_arcs = 554,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 555,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 556,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 557,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 558,              /* -fprofile-generate= */
  OPT_fprofile_use = 559,                    /* -fprofile-use */
  OPT_fprofile_use_ = 560,                   /* -fprofile-use= */
  OPT_fprofile_values = 561,                 /* -fprofile-values */
  OPT_frandom_seed = 562,                    /* -frandom-seed */
  OPT_frandom_seed_ = 563,                   /* -frandom-seed= */
  OPT_freciprocal_math = 564,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 565,            /* -frecord-gcc-switches */
  OPT_freg_struct_return = 566,              /* -freg-struct-return */
  OPT_fregmove = 567,                        /* -fregmove */
  OPT_frename_registers = 568,               /* -frename-registers */
  OPT_freorder_blocks = 569,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 570,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 571,              /* -freorder-functions */
  OPT_freplace_objc_classes = 572,           /* -freplace-objc-classes */
  OPT_frepo = 573,                           /* -frepo */
  OPT_frerun_cse_after_loop = 574,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 575, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 576,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 577,                    /* -fresolution= */
  OPT_frounding_math = 578,                  /* -frounding-math */
  OPT_frtti = 579,                           /* -frtti */
  OPT_fsched_critical_path_heuristic = 580,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 581,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 582,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 583,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 584,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 585,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 586,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 587,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 588,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 589,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 590,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 591,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 592,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 593,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 594,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 595,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 596,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 597, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 598,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 599,                /* -fschedule-insns2 */
  OPT_fsection_anchors = 600,                /* -fsection-anchors */
  /* OPT_fsee = 601, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 602,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 603,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 604, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 605,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 606,          /* -fselective-scheduling2 */
  OPT_fset_stack_executable = 607,           /* -fset-stack-executable */
  OPT_fshort_double = 608,                   /* -fshort-double */
  OPT_fshort_enums = 609,                    /* -fshort-enums */
  OPT_fshort_wchar = 610,                    /* -fshort-wchar */
  OPT_fshow_column = 611,                    /* -fshow-column */
  OPT_fsignaling_nans = 612,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 613,               /* -fsigned-bitfields */
  OPT_fsigned_char = 614,                    /* -fsigned-char */
  OPT_fsigned_zeros = 615,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 616,      /* -fsingle-precision-constant */
  OPT_fsplit_ivs_in_unroller = 617,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 618,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 619,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 620, */                 /* -fsquangle */
  /* OPT_fstack_check = 621, */              /* -fstack-check */
  OPT_fstack_check_ = 622,                   /* -fstack-check= */
  OPT_fstack_limit = 623,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 624,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 625,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 626,                /* -fstack-protector */
  OPT_fstack_protector_all = 627,            /* -fstack-protector-all */
  OPT_fstack_usage = 628,                    /* -fstack-usage */
  OPT_fstats = 629,                          /* -fstats */
  /* OPT_fstrength_reduce = 630, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 631,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 632,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 633,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 634, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 635,      /* -fstrict-volatile-bitfields */
  OPT_fsyntax_only = 636,                    /* -fsyntax-only */
  OPT_ftabstop_ = 637,                       /* -ftabstop= */
  /* OPT_ftarget_help = 638, */              /* -ftarget-help */
  /* OPT_ftemplate_depth_ = 639, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 640,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 641,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 642, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 643,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 644,             /* -fthreadsafe-statics */
  OPT_ftime_report = 645,                    /* -ftime-report */
  OPT_ftls_model_ = 646,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 647,               /* -ftoplevel-reorder */
  OPT_ftracer = 648,                         /* -ftracer */
  OPT_ftrapping_math = 649,                  /* -ftrapping-math */
  OPT_ftrapv = 650,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 651,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 652,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 653,                       /* -ftree-ccp */
  OPT_ftree_ch = 654,                        /* -ftree-ch */
  OPT_ftree_copy_prop = 655,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 656,                /* -ftree-copyrename */
  OPT_ftree_cselim = 657,                    /* -ftree-cselim */
  OPT_ftree_dce = 658,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 659,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 660,                       /* -ftree-dse */
  OPT_ftree_forwprop = 661,                  /* -ftree-forwprop */
  OPT_ftree_fre = 662,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 663,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 664,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 665,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 666,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 667,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 668,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 669, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 670,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 671,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 672,        /* -ftree-parallelize-loops= */
  OPT_ftree_phiprop = 673,                   /* -ftree-phiprop */
  OPT_ftree_pre = 674,                       /* -ftree-pre */
  OPT_ftree_pta = 675,                       /* -ftree-pta */
  OPT_ftree_reassoc = 676,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 677, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 678,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 679,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 680,             /* -ftree-slp-vectorize */
  OPT_ftree_sra = 681,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 682, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 683, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 684,         /* -ftree-switch-conversion */
  OPT_ftree_ter = 685,                       /* -ftree-ter */
  OPT_ftree_vect_loop_version = 686,         /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 687,                 /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 688,       /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 689,                       /* -ftree-vrp */
  OPT_funit_at_a_time = 690,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 691,               /* -funroll-all-loops */
  OPT_funroll_loops = 692,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 693,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 694,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 695,             /* -funsigned-bitfields */
  OPT_funsigned_char = 696,                  /* -funsigned-char */
  OPT_funswitch_loops = 697,                 /* -funswitch-loops */
  OPT_funwind_tables = 698,                  /* -funwind-tables */
  OPT_fuse_cxa_atexit = 699,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 700,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_linker_plugin = 701,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 702,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 703,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 704,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 705,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 706, /* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 707,                /* -fvect-cost-model */
  OPT_fverbose_asm = 708,                    /* -fverbose-asm */
  /* OPT_fversion = 709, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 710,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 711,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 712,                    /* -fvisibility= */
  OPT_fvpt = 713,                            /* -fvpt */
  /* OPT_fvtable_gc = 714, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 715, */            /* -fvtable-thunks */
  OPT_fweak = 716,                           /* -fweak */
  OPT_fweb = 717,                            /* -fweb */
  OPT_fwhole_program = 718,                  /* -fwhole-program */
  OPT_fwide_exec_charset_ = 719,             /* -fwide-exec-charset= */
  OPT_fworking_directory = 720,              /* -fworking-directory */
  OPT_fwpa = 721,                            /* -fwpa */
  OPT_fwrapv = 722,                          /* -fwrapv */
  /* OPT_fxref = 723, */                     /* -fxref */
  OPT_fzee = 724,                            /* -fzee */
  OPT_fzero_initialized_in_bss = 725,        /* -fzero-initialized-in-bss */
  OPT_fzero_link = 726,                      /* -fzero-link */
  OPT_g = 727,                               /* -g */
  OPT_gcoff = 728,                           /* -gcoff */
  OPT_gdwarf_ = 729,                         /* -gdwarf- */
  OPT_gen_decls = 730,                       /* -gen-decls */
  OPT_ggdb = 731,                            /* -ggdb */
  OPT_gno_strict_dwarf = 732,                /* -gno-strict-dwarf */
  OPT_gstabs = 733,                          /* -gstabs */
  OPT_gstabs_ = 734,                         /* -gstabs+ */
  OPT_gstrict_dwarf = 735,                   /* -gstrict-dwarf */
  OPT_gtoggle = 736,                         /* -gtoggle */
  OPT_gvms = 737,                            /* -gvms */
  OPT_gxcoff = 738,                          /* -gxcoff */
  OPT_gxcoff_ = 739,                         /* -gxcoff+ */
  OPT_h = 740,                               /* -h */
  OPT_idirafter = 741,                       /* -idirafter */
  OPT_imacros = 742,                         /* -imacros */
  OPT_imultiarch = 743,                      /* -imultiarch */
  OPT_imultilib = 744,                       /* -imultilib */
  OPT_include = 745,                         /* -include */
  OPT_iplugindir_ = 746,                     /* -iplugindir= */
  OPT_iprefix = 747,                         /* -iprefix */
  OPT_iquote = 748,                          /* -iquote */
  OPT_isysroot = 749,                        /* -isysroot */
  OPT_isystem = 750,                         /* -isystem */
  OPT_iwithprefix = 751,                     /* -iwithprefix */
  OPT_iwithprefixbefore = 752,               /* -iwithprefixbefore */
  OPT_l = 753,                               /* -l */
  OPT_lang_asm = 754,                        /* -lang-asm */
  OPT_m128bit_long_double = 755,             /* -m128bit-long-double */
  OPT_m32 = 756,                             /* -m32 */
  OPT_m3dnow = 757,                          /* -m3dnow */
  OPT_m3dnowa = 758,                         /* -m3dnowa */
  OPT_m64 = 759,                             /* -m64 */
  OPT_m80387 = 760,                          /* -m80387 */
  OPT_m8bit_idiv = 761,                      /* -m8bit-idiv */
  OPT_m96bit_long_double = 762,              /* -m96bit-long-double */
  OPT_mabi_ = 763,                           /* -mabi= */
  OPT_mabm = 764,                            /* -mabm */
  OPT_maccumulate_outgoing_args = 765,       /* -maccumulate-outgoing-args */
  OPT_maes = 766,                            /* -maes */
  OPT_malign_double = 767,                   /* -malign-double */
  OPT_malign_functions_ = 768,               /* -malign-functions= */
  OPT_malign_jumps_ = 769,                   /* -malign-jumps= */
  OPT_malign_loops_ = 770,                   /* -malign-loops= */
  OPT_malign_stringops = 771,                /* -malign-stringops */
  OPT_march_ = 772,                          /* -march= */
  OPT_masm_ = 773,                           /* -masm= */
  OPT_mavx = 774,                            /* -mavx */
  OPT_mavx256_split_unaligned_load = 775,    /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 776,   /* -mavx256-split-unaligned-store */
  OPT_mbmi = 777,                            /* -mbmi */
  OPT_mbranch_cost_ = 778,                   /* -mbranch-cost= */
  OPT_mcld = 779,                            /* -mcld */
  OPT_mcmodel_ = 780,                        /* -mcmodel= */
  OPT_mconsole = 781,                        /* -mconsole */
  /* OPT_mcpu_ = 782, */                     /* -mcpu= */
  OPT_mcrc32 = 783,                          /* -mcrc32 */
  OPT_mcx16 = 784,                           /* -mcx16 */
  OPT_mdispatch_scheduler = 785,             /* -mdispatch-scheduler */
  OPT_mdll = 786,                            /* -mdll */
  OPT_mf16c = 787,                           /* -mf16c */
  OPT_mfancy_math_387 = 788,                 /* -mfancy-math-387 */
  OPT_mfentry = 789,                         /* -mfentry */
  OPT_mfma = 790,                            /* -mfma */
  OPT_mfma4 = 791,                           /* -mfma4 */
  OPT_mforce_drap = 792,                     /* -mforce-drap */
  OPT_mfp_ret_in_387 = 793,                  /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 794,                        /* -mfpmath= */
  OPT_mfsgsbase = 795,                       /* -mfsgsbase */
  /* OPT_mfused_madd = 796, */               /* -mfused-madd */
  OPT_mhard_float = 797,                     /* -mhard-float */
  OPT_mieee_fp = 798,                        /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 799,       /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 800,           /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 801,   /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 802, */             /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 803,          /* -mlarge-data-threshold= */
  OPT_mlwp = 804,                            /* -mlwp */
  OPT_mmmx = 805,                            /* -mmmx */
  OPT_mmovbe = 806,                          /* -mmovbe */
  OPT_mms_bitfields = 807,                   /* -mms-bitfields */
  OPT_mno_align_stringops = 808,             /* -mno-align-stringops */
  OPT_mno_fancy_math_387 = 809,              /* -mno-fancy-math-387 */
  OPT_mno_push_args = 810,                   /* -mno-push-args */
  OPT_mno_red_zone = 811,                    /* -mno-red-zone */
  OPT_mno_sse4 = 812,                        /* -mno-sse4 */
  OPT_mnop_fun_dllimport = 813,              /* -mnop-fun-dllimport */
  OPT_momit_leaf_frame_pointer = 814,        /* -momit-leaf-frame-pointer */
  OPT_mpc = 815,                             /* -mpc */
  OPT_mpclmul = 816,                         /* -mpclmul */
  OPT_mpe_aligned_commons = 817,             /* -mpe-aligned-commons */
  OPT_mpopcnt = 818,                         /* -mpopcnt */
  OPT_mprefer_avx128 = 819,                  /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 820,      /* -mpreferred-stack-boundary= */
  OPT_mpush_args = 821,                      /* -mpush-args */
  OPT_mrdrnd = 822,                          /* -mrdrnd */
  OPT_mrecip = 823,                          /* -mrecip */
  OPT_mred_zone = 824,                       /* -mred-zone */
  OPT_mregparm_ = 825,                       /* -mregparm= */
  OPT_mrtd = 826,                            /* -mrtd */
  OPT_msahf = 827,                           /* -msahf */
  OPT_msoft_float = 828,                     /* -msoft-float */
  OPT_msse = 829,                            /* -msse */
  OPT_msse2 = 830,                           /* -msse2 */
  OPT_msse2avx = 831,                        /* -msse2avx */
  OPT_msse3 = 832,                           /* -msse3 */
  OPT_msse4 = 833,                           /* -msse4 */
  OPT_msse4_1 = 834,                         /* -msse4.1 */
  OPT_msse4_2 = 835,                         /* -msse4.2 */
  OPT_msse4a = 836,                          /* -msse4a */
  /* OPT_msse5 = 837, */                     /* -msse5 */
  OPT_msseregparm = 838,                     /* -msseregparm */
  OPT_mssse3 = 839,                          /* -mssse3 */
  OPT_mstack_arg_probe = 840,                /* -mstack-arg-probe */
  OPT_mstackrealign = 841,                   /* -mstackrealign */
  OPT_mstringop_strategy_ = 842,             /* -mstringop-strategy= */
  OPT_mtbm = 843,                            /* -mtbm */
  OPT_mthreads = 844,                        /* -mthreads */
  OPT_mtls_dialect_ = 845,                   /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 846,            /* -mtls-direct-seg-refs */
  OPT_mtune_ = 847,                          /* -mtune= */
  OPT_muse_libstdc_wrappers = 848,           /* -muse-libstdc-wrappers */
  OPT_mveclibabi_ = 849,                     /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 850,               /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 851,                     /* -mvzeroupper */
  OPT_mwin32 = 852,                          /* -mwin32 */
  OPT_mwindows = 853,                        /* -mwindows */
  OPT_mxop = 854,                            /* -mxop */
  OPT_n = 855,                               /* -n */
  OPT_no_canonical_prefixes = 856,           /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 857,               /* -no-integrated-cpp */
  OPT_nodefaultlibs = 858,                   /* -nodefaultlibs */
  OPT_nostartfiles = 859,                    /* -nostartfiles */
  OPT_nostdinc = 860,                        /* -nostdinc */
  OPT_nostdinc__ = 861,                      /* -nostdinc++ */
  OPT_nostdlib = 862,                        /* -nostdlib */
  OPT_o = 863,                               /* -o */
  OPT_p = 864,                               /* -p */
  OPT_pass_exit_codes = 865,                 /* -pass-exit-codes */
  OPT_pedantic = 866,                        /* -pedantic */
  OPT_pedantic_errors = 867,                 /* -pedantic-errors */
  OPT_pg = 868,                              /* -pg */
  OPT_pie = 869,                             /* -pie */
  OPT_pipe = 870,                            /* -pipe */
  OPT_posix = 871,                           /* -posix */
  OPT_print_file_name_ = 872,                /* -print-file-name= */
  OPT_print_libgcc_file_name = 873,          /* -print-libgcc-file-name */
  OPT_print_multi_directory = 874,           /* -print-multi-directory */
  OPT_print_multi_lib = 875,                 /* -print-multi-lib */
  OPT_print_multi_os_directory = 876,        /* -print-multi-os-directory */
  OPT_print_multiarch = 877,                 /* -print-multiarch */
  OPT_print_objc_runtime_info = 878,         /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 879,                /* -print-prog-name= */
  OPT_print_search_dirs = 880,               /* -print-search-dirs */
  OPT_print_sysroot = 881,                   /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 882,    /* -print-sysroot-headers-suffix */
  OPT_quiet = 883,                           /* -quiet */
  OPT_r = 884,                               /* -r */
  OPT_remap = 885,                           /* -remap */
  OPT_s = 886,                               /* -s */
  OPT_save_temps = 887,                      /* -save-temps */
  OPT_save_temps_ = 888,                     /* -save-temps= */
  OPT_shared = 889,                          /* -shared */
  OPT_shared_libgcc = 890,                   /* -shared-libgcc */
  /* OPT_specs = 891, */                     /* -specs */
  OPT_specs_ = 892,                          /* -specs= */
  OPT_static = 893,                          /* -static */
  OPT_static_libgcc = 894,                   /* -static-libgcc */
  OPT_static_libgfortran = 895,              /* -static-libgfortran */
  OPT_static_libgo = 896,                    /* -static-libgo */
  OPT_static_libstdc__ = 897,                /* -static-libstdc++ */
  /* OPT_std_c__03 = 898, */                 /* -std=c++03 */
  OPT_std_c__0x = 899,                       /* -std=c++0x */
  OPT_std_c__98 = 900,                       /* -std=c++98 */
  OPT_std_c1x = 901,                         /* -std=c1x */
  /* OPT_std_c89 = 902, */                   /* -std=c89 */
  OPT_std_c90 = 903,                         /* -std=c90 */
  OPT_std_c99 = 904,                         /* -std=c99 */
  /* OPT_std_c9x = 905, */                   /* -std=c9x */
  OPT_std_gnu__0x = 906,                     /* -std=gnu++0x */
  OPT_std_gnu__98 = 907,                     /* -std=gnu++98 */
  OPT_std_gnu1x = 908,                       /* -std=gnu1x */
  /* OPT_std_gnu89 = 909, */                 /* -std=gnu89 */
  OPT_std_gnu90 = 910,                       /* -std=gnu90 */
  OPT_std_gnu99 = 911,                       /* -std=gnu99 */
  /* OPT_std_gnu9x = 912, */                 /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 913, */          /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 914,              /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 915, */          /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 916, */          /* -std=iso9899:199x */
  OPT_symbolic = 917,                        /* -symbolic */
  OPT_t = 918,                               /* -t */
  OPT_time = 919,                            /* -time */
  OPT_time_ = 920,                           /* -time= */
  OPT_traditional = 921,                     /* -traditional */
  OPT_traditional_cpp = 922,                 /* -traditional-cpp */
  OPT_trigraphs = 923,                       /* -trigraphs */
  OPT_u = 924,                               /* -u */
  OPT_undef = 925,                           /* -undef */
  OPT_v = 926,                               /* -v */
  OPT_version = 927,                         /* -version */
  OPT_w = 928,                               /* -w */
  OPT_wrapper = 929,                         /* -wrapper */
  OPT_x = 930,                               /* -x */
  OPT_z = 931,                               /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
