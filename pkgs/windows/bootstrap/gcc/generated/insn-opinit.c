...
init_all_optabs (void)
{
  ...
  if (HAVE_vec_interleave_highv4sf)
    set_optab_handler (vec_interleave_high_optab, V4SFmode, CODE_FOR_vec_interleave_highv4sf);
  if (HAVE_vec_interleave_lowv4sf)
    set_optab_handler (vec_interleave_low_optab, V4SFmode, CODE_FOR_vec_interleave_lowv4sf);
  if (HAVE_vec_interleave_highv2di)
    set_optab_handler (vec_interleave_high_optab, V2DImode, CODE_FOR_vec_interleave_highv2di);
  if (HAVE_vec_interleave_lowv2di)
    set_optab_handler (vec_interleave_low_optab, V2DImode, CODE_FOR_vec_interleave_lowv2di);
  if (HAVE_mulv16qi3)
  ...
  if (HAVE_vec_interleave_highv16qi)
    set_optab_handler (vec_interleave_high_optab, V16QImode, CODE_FOR_vec_interleave_highv16qi);
  if (HAVE_vec_interleave_lowv16qi)
    set_optab_handler (vec_interleave_low_optab, V16QImode, CODE_FOR_vec_interleave_lowv16qi);
  if (HAVE_vec_interleave_highv8hi)
    set_optab_handler (vec_interleave_high_optab, V8HImode, CODE_FOR_vec_interleave_highv8hi);
  if (HAVE_vec_interleave_lowv8hi)
    set_optab_handler (vec_interleave_low_optab, V8HImode, CODE_FOR_vec_interleave_lowv8hi);
  if (HAVE_vec_interleave_highv4si)
    set_optab_handler (vec_interleave_high_optab, V4SImode, CODE_FOR_vec_interleave_highv4si);
  if (HAVE_vec_interleave_lowv4si)
    set_optab_handler (vec_interleave_low_optab, V4SImode, CODE_FOR_vec_interleave_lowv4si);
  if (HAVE_absv16qi2)
  ...
  if (HAVE_mulqihi3)
    set_optab_handler (smul_widen_optab, HImode, CODE_FOR_mulqihi3);
  if (HAVE_umulqihi3)
    set_optab_handler (umul_widen_optab, HImode, CODE_FOR_umulqihi3);
  ...
  if (HAVE_vcondv2df)
    set_direct_optab_handler (vcond_optab, V2DFmode, CODE_FOR_vcondv2df);
  if (HAVE_vcondv8sf)
    set_direct_optab_handler (vcond_optab, V8SFmode, CODE_FOR_vcondv8sf);
  if (HAVE_vcondv4df)
    set_direct_optab_handler (vcond_optab, V4DFmode, CODE_FOR_vcondv4df);
  if (HAVE_andv8sf3)
  ...
  if (HAVE_vec_interleave_highv8sf)
    set_optab_handler (vec_interleave_high_optab, V8SFmode, CODE_FOR_vec_interleave_highv8sf);
  if (HAVE_vec_interleave_lowv8sf)
    set_optab_handler (vec_interleave_low_optab, V8SFmode, CODE_FOR_vec_interleave_lowv8sf);
  ...
  if (HAVE_vec_interleave_highv4df)
    set_optab_handler (vec_interleave_high_optab, V4DFmode, CODE_FOR_vec_interleave_highv4df);
  if (HAVE_vec_interleave_highv2df)
    set_optab_handler (vec_interleave_high_optab, V2DFmode, CODE_FOR_vec_interleave_highv2df);
  if (HAVE_vec_interleave_lowv4df)
    set_optab_handler (vec_interleave_low_optab, V4DFmode, CODE_FOR_vec_interleave_lowv4df);
  if (HAVE_vec_interleave_lowv2df)
    set_optab_handler (vec_interleave_low_optab, V2DFmode, CODE_FOR_vec_interleave_lowv2df);
  if (HAVE_vec_extract_evenv4sf)
    set_optab_handler (vec_extract_even_optab, V4SFmode, CODE_FOR_vec_extract_evenv4sf);
  if (HAVE_vec_extract_evenv2df)
    set_optab_handler (vec_extract_even_optab, V2DFmode, CODE_FOR_vec_extract_evenv2df);
  if (HAVE_vec_extract_evenv2di)
    set_optab_handler (vec_extract_even_optab, V2DImode, CODE_FOR_vec_extract_evenv2di);
  if (HAVE_vec_extract_evenv4si)
    set_optab_handler (vec_extract_even_optab, V4SImode, CODE_FOR_vec_extract_evenv4si);
  if (HAVE_vec_extract_evenv8hi)
    set_optab_handler (vec_extract_even_optab, V8HImode, CODE_FOR_vec_extract_evenv8hi);
  if (HAVE_vec_extract_evenv16qi)
    set_optab_handler (vec_extract_even_optab, V16QImode, CODE_FOR_vec_extract_evenv16qi);
  if (HAVE_vec_extract_evenv4df)
    set_optab_handler (vec_extract_even_optab, V4DFmode, CODE_FOR_vec_extract_evenv4df);
  if (HAVE_vec_extract_evenv8sf)
    set_optab_handler (vec_extract_even_optab, V8SFmode, CODE_FOR_vec_extract_evenv8sf);
  if (HAVE_vec_extract_oddv4sf)
    set_optab_handler (vec_extract_odd_optab, V4SFmode, CODE_FOR_vec_extract_oddv4sf);
  if (HAVE_vec_extract_oddv2df)
    set_optab_handler (vec_extract_odd_optab, V2DFmode, CODE_FOR_vec_extract_oddv2df);
  if (HAVE_vec_extract_oddv2di)
    set_optab_handler (vec_extract_odd_optab, V2DImode, CODE_FOR_vec_extract_oddv2di);
  if (HAVE_vec_extract_oddv4si)
    set_optab_handler (vec_extract_odd_optab, V4SImode, CODE_FOR_vec_extract_oddv4si);
  if (HAVE_vec_extract_oddv8hi)
    set_optab_handler (vec_extract_odd_optab, V8HImode, CODE_FOR_vec_extract_oddv8hi);
  if (HAVE_vec_extract_oddv16qi)
    set_optab_handler (vec_extract_odd_optab, V16QImode, CODE_FOR_vec_extract_oddv16qi);
  if (HAVE_vec_extract_oddv4df)
    set_optab_handler (vec_extract_odd_optab, V4DFmode, CODE_FOR_vec_extract_oddv4df);
  if (HAVE_vec_extract_oddv8sf)
    set_optab_handler (vec_extract_odd_optab, V8SFmode, CODE_FOR_vec_extract_oddv8sf);
  if (HAVE_negv16qi2)
  ...
  if (HAVE_vcondv2di)
    set_direct_optab_handler (vcond_optab, V2DImode, CODE_FOR_vcondv2di);
  if (HAVE_vconduv16qi)
  ...
  if (HAVE_vconduv2di)
    set_direct_optab_handler (vcondu_optab, V2DImode, CODE_FOR_vconduv2di);
