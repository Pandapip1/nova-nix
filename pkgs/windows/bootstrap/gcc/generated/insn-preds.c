/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/i386.md'.  */
...
#line 24 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == REG) && (
#line 29 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
(FP_REGNO_P (REGNO (op))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return ((GET_CODE (op) == REG) && (!(
#line 34 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
(ANY_FP_REGNO_P (REGNO (op)))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return ((GET_CODE (op) == REG) && (!(
#line 39 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
(FP_REGNO_P (REGNO (op)))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return ((GET_CODE (op) == REG) && (
#line 44 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == REG) && (
#line 49 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
#line 54 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
...
#line 63 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
...
{
  return ((GET_CODE (op) == REG) && (
#line 78 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
(REGNO (op) == AX_REG))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return ((GET_CODE (op) == REG) && (
#line 83 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
(REGNO (op) == FLAGS_REG))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return ((GET_CODE (op) == REG) && (
#line 89 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
(TARGET_64BIT
		    && GET_MODE (op) == QImode
		    && REGNO (op) > BX_REG))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
...
{
  return ((GET_CODE (op) == REG) && (
#line 96 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
(TARGET_64BIT
		    && REGNO (op) > BX_REG))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
#line 102 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
  if (GET_CODE (op) == SUBREG)
    op = SUBREG_REG (op);
...
#line 117 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
  if (!TARGET_64BIT)
...
#line 244 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
  switch (GET_CODE (op))
    {
    case CONST_DOUBLE:
...
{
  return (
#line 329 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
{
  return (
#line 337 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
{
  return (
#line 345 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
{
  return (
#line 352 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
#line 362 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
  if (!flag_pic)
    return false;
...
{
  return (
#line 382 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
(!TARGET_64BIT || !flag_pic)) ? (nonmemory_operand (op, mode)) : ((register_operand (op, mode)) || ((const_double_operand (op, mode)) && (
#line 386 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
(GET_MODE_SIZE (mode) <= 8))));
}

static inline int
symbolic_operand_1 (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
#line 392 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
  switch (GET_CODE (op))
    {
    case SYMBOL_REF:
...
#line 435 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
...
{
  return (
#line 474 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
#line 480 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == SYMBOL_REF) && (
#line 484 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
#line 489 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
(XINT (op, 1) == UNSPEC_TP))) && (
(mode == VOIDmode || GET_MODE (op) == mode)));
}
...
#line 494 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
...
#line 508 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
  if (GET_CODE (op) == SUBREG)
    op = SUBREG_REG (op);
...
#line 522 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
  if (GET_CODE (op) == SUBREG)
    op = SUBREG_REG (op);
...
#line 535 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
  if (GET_CODE (op) == SUBREG)
    op = SUBREG_REG (op);
...
#line 570 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
  if (mode == VOIDmode)
    mode = GET_MODE (op);
...
#line 579 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
(op == const1_rtx));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 584 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
(INTVAL (op) == 8));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 589 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
(INTVAL (op) == 128));
}

static inline int
const248_operand_1 (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
#line 594 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 602 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 607 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 612 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 617 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 622 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 627 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 632 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
(IN_RANGE (INTVAL (op), 0, 255)));
}

static inline int
const_0_to_255_mul_8_operand_1 (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
#line 637 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 646 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 652 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 657 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 662 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 667 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 672 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 677 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 682 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 687 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
(INTVAL (op) == 1 || INTVAL (op) == 2));
}

static inline int
const_pow2_1_to_8_operand_1 (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
#line 692 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
...
#line 700 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
  unsigned int log = exact_log2 (INTVAL (op));
  return log <= 7;
}
...
#line 708 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
  unsigned int log = exact_log2 (INTVAL (op));
  return log <= 15;
}
...
#line 716 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
...
#line 728 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
{
  return (
#line 732 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
{
  return (
#line 737 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
#line 745 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
  unsigned n_elts;
...
#line 766 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
...
#line 793 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
...
#line 810 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
...
#line 822 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 878 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 890 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 910 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
{
  return (memory_operand (op, mode)) && (
#line 938 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
(memory_address_length (op)));
}

static inline int
fcmov_comparison_operator_1 (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
#line 943 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
...
#line 993 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
  enum machine_mode inmode = GET_MODE (XEXP (op, 0));
  enum rtx_code code = GET_CODE (op);
...
#line 1030 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
  enum machine_mode inmode = GET_MODE (XEXP (op, 0));
  enum rtx_code code = GET_CODE (op);
...
{
  return (
#line 1056 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
#line 1064 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
  enum rtx_code code = GET_CODE (op);
  bool ret;
...
#line 1110 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == MEM) && (
#line 1121 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
#line 1126 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
  unsigned i;
...
#line 1156 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
...
{
  return ((GET_CODE (op) == PARALLEL) && (
#line 1183 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == PARALLEL) && (
#line 1187 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == PARALLEL) && (
#line 1191 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == PARALLEL) && (
#line 1195 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == PARALLEL) && (
#line 1201 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == PARALLEL) && (
#line 1205 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == PARALLEL) && (
#line 1209 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
...
#line 1216 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/predicates.md"
{
...
insn_const_int_ok_for_constraint (HOST_WIDE_INT ival, enum constraint_num c)
{
  switch (c)
    ...
    case CONSTRAINT_I:
      return 
#line 116 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 31));

    case CONSTRAINT_J:
      return 
#line 121 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 63));

    case CONSTRAINT_K:
      return 
#line 126 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/constraints.md"
(IN_RANGE (ival, -128, 127));

    case CONSTRAINT_L:
      return 
#line 131 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/constraints.md"
(ival == 0xFF || ival == 0xFFFF);

    case CONSTRAINT_M:
      return 
#line 136 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 3));

    case CONSTRAINT_N:
      return 
#line 142 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 255));

    case CONSTRAINT_O:
      return 
#line 147 "/tmp/claude/gcc-scope/gcc-4.6.4/gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 127));
