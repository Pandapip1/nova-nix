...
#define __GMP_BITS_PER_MP_LIMB             32 /* ntlibc audit: ILP32 i686-pc-mingw32 target, unsigned long is 32 bits not the reference x86_64-linux host's 64 -- see config.h's SIZEOF_MP_LIMB_T */
