# Taken from nixpkgs' minimal-bootstrap (pkgs/os-specific/linux/minimal-bootstrap/gnugrep),
# which wrote it because grep's own Makefile.in comes from a configure this
# bootstrap cannot run.  Kept as-is; the archive rule is rewritten at build time,
