...
enum gt_types_enum {
 ...
 gt_ggc_e_7tinfo_s,
 gt_ggc_e_11export_list,
 gt_ggc_e_11extern_list,
...
#define ggc_alloc_export_list() ((struct export_list *)(ggc_internal_alloc_stat (sizeof (struct export_list) MEM_STAT_INFO)))
#define ggc_alloc_cleared_export_list() ((struct export_list *)(ggc_internal_cleared_alloc_stat (sizeof (struct export_list) MEM_STAT_INFO)))
#define ggc_alloc_vec_export_list(n) ((struct export_list *)(ggc_internal_vec_alloc_stat (sizeof (struct export_list), n MEM_STAT_INFO)))
#define ggc_alloc_cleared_vec_export_list(n) ((struct export_list *)(ggc_internal_cleared_vec_alloc_stat (sizeof (struct export_list), n MEM_STAT_INFO)))
#define ggc_alloc_zone_export_list(z) ((struct export_list *)(ggc_internal_zone_alloc_stat (z, sizeof (struct export_list) MEM_STAT_INFO)))
#define ggc_alloc_zone_cleared_export_list(z) ((struct export_list *)(ggc_internal_zone_cleared_alloc_stat (z, sizeof (struct export_list) MEM_STAT_INFO)))
#define ggc_alloc_zone_vec_export_list(n, z) ((struct export_list *)(ggc_internal_zone_vec_alloc_stat (z, sizeof (struct export_list), n MEM_STAT_INFO)))
#define ggc_alloc_zone_cleared_vec_export_list(n, z) ((struct export_list *)(ggc_internal_zone_cleared_vec_alloc_stat (z, sizeof (struct export_list), n MEM_STAT_INFO)))
#define ggc_alloc_extern_list() ((struct extern_list *)(ggc_internal_alloc_stat (sizeof (struct extern_list) MEM_STAT_INFO)))
#define ggc_alloc_cleared_extern_list() ((struct extern_list *)(ggc_internal_cleared_alloc_stat (sizeof (struct extern_list) MEM_STAT_INFO)))
#define ggc_alloc_vec_extern_list(n) ((struct extern_list *)(ggc_internal_vec_alloc_stat (sizeof (struct extern_list), n MEM_STAT_INFO)))
#define ggc_alloc_cleared_vec_extern_list(n) ((struct extern_list *)(ggc_internal_cleared_vec_alloc_stat (sizeof (struct extern_list), n MEM_STAT_INFO)))
#define ggc_alloc_zone_extern_list(z) ((struct extern_list *)(ggc_internal_zone_alloc_stat (z, sizeof (struct extern_list) MEM_STAT_INFO)))
#define ggc_alloc_zone_cleared_extern_list(z) ((struct extern_list *)(ggc_internal_zone_cleared_alloc_stat (z, sizeof (struct extern_list) MEM_STAT_INFO)))
#define ggc_alloc_zone_vec_extern_list(n, z) ((struct extern_list *)(ggc_internal_zone_vec_alloc_stat (z, sizeof (struct extern_list), n MEM_STAT_INFO)))
#define ggc_alloc_zone_cleared_vec_extern_list(n, z) ((struct extern_list *)(ggc_internal_zone_cleared_vec_alloc_stat (z, sizeof (struct extern_list), n MEM_STAT_INFO)))
...
#define ggc_alloc_zone_stack_local_entry(z) ((struct stack_local_entry *)(ggc_internal_zone_alloc_stat (z, sizeof (struct stack_local_entry) MEM_STAT_INFO)))
#define ggc_alloc_zone_cleared_stack_local_entry(z) ((struct stack_local_entry *)(ggc_internal_zone_cleared_alloc_stat (z, sizeof (struct stack_local_entry) MEM_STAT_INFO)))
#define ggc_alloc_zone_vec_stack_local_entry(n, z) ((struct stack_local_entry *)(ggc_internal_zone_vec_alloc_stat (z, sizeof (struct stack_local_entry), n MEM_STAT_INFO)))
#define ggc_alloc_zone_cleared_vec_stack_local_entry(n, z) ((struct stack_local_entry *)(ggc_internal_zone_cleared_vec_alloc_stat (z, sizeof (struct stack_local_entry), n MEM_STAT_INFO)))
...
#define ggc_alloc_zone_machine_frame_state(z) ((struct machine_frame_state *)(ggc_internal_zone_alloc_stat (z, sizeof (struct machine_frame_state) MEM_STAT_INFO)))
#define ggc_alloc_zone_cleared_machine_frame_state(z) ((struct machine_frame_state *)(ggc_internal_zone_cleared_alloc_stat (z, sizeof (struct machine_frame_state) MEM_STAT_INFO)))
#define ggc_alloc_zone_vec_machine_frame_state(n, z) ((struct machine_frame_state *)(ggc_internal_zone_vec_alloc_stat (z, sizeof (struct machine_frame_state), n MEM_STAT_INFO)))
#define ggc_alloc_zone_cleared_vec_machine_frame_state(n, z) ((struct machine_frame_state *)(ggc_internal_zone_cleared_vec_alloc_stat (z, sizeof (struct machine_frame_state), n MEM_STAT_INFO)))
...
#define gt_ggc_m_11export_list(X) do { \
  if (X != NULL) gt_ggc_mx_export_list (X);\
  } while (0)
extern void gt_ggc_mx_export_list (void *);
#define gt_ggc_m_11extern_list(X) do { \
  if (X != NULL) gt_ggc_mx_extern_list (X);\
  } while (0)
extern void gt_ggc_mx_extern_list (void *);
...
#define gt_pch_n_11export_list(X) do { \
  if (X != NULL) gt_pch_nx_export_list (X);\
  } while (0)
extern void gt_pch_nx_export_list (void *);
#define gt_pch_n_11extern_list(X) do { \
  if (X != NULL) gt_pch_nx_extern_list (X);\
  } while (0)
extern void gt_pch_nx_extern_list (void *);
...
extern void gt_pch_p_14VEC_tinfo_s_gc
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_11export_list
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_11extern_list
    (void *, void *, gt_pointer_operator, void *);
