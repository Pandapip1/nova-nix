...
# documented at length in ../../by-name/gc/gcc/windows/build.kaem's own tail (the
...
#      ../../by-name/gc/gcc/windows/default.nix's own "what this package does NOT
...
# in tcc, per ../../by-name/gc/gcc/windows/build.kaem's own reasoning for installing
...
# crt1.o, -L ntlibc/lib -lc -lntdll, mirroring ../../by-name/gc/gcc/windows/build.kaem's
